...
extern void suppress(const vec2 &vA, vec2 &vA1, const vec2 &vr,
                     const vec2 &vrj);
extern auto check_newton(const vec2 &vA, const vec2 &vA1, const vec2 &vr)
    -> vec2;
extern auto horner_eval(std::vector<double> &pb, std::size_t n, const double &r)
    -> double;
