...
/* The `LowpassOracleQ` class is a wrapper class that provides an interface for optimizing a lowpass
...
class LowpassOracleQ {
  ...
  public:
     ...
     * parameters: `nnz` of type `unsigned int` and `lowpass` of type `LowpassOracle&&` (an rvalue
     * reference to a `LowpassOracle` object). */
