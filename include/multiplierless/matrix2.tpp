...
public:
   ...
   * @return matrix2
   */
  constexpr auto operator-() const -> matrix2 {
    return matrix2(-this->x(), -this->y());
  }
   ...
   */
  template <typename U1, typename U2> //
  friend constexpr auto operator+(matrix2 x, const matrix2<U1, U2> &y)
      -> matrix2 {
    return x += y;
  }
   ...
   */
  template <typename R>
  friend constexpr auto operator*(matrix2 x, const R &alpha) -> matrix2 {
    return x *= alpha;
  }
   ...
   */
  template <typename R>
  friend constexpr auto operator*(const R &alpha, matrix2 x) -> matrix2 {
    return x *= alpha;
  }
